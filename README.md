...
OTA for the ESP for program update is started when the I2C communication fails, this can be triggered by
resetting the ESP by pulling the RST line low. Because the attiny is most of the time sleeping
